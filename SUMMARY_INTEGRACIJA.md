...
- **URL:** `https://spa-cors-sync.preview.emergentagent.com/api/services`
...
```bash
curl https://spa-cors-sync.preview.emergentagent.com/api/services | jq
```

### Test 2: Postavi popust u booking sistemu
1. Idi na: https://spa-cors-sync.preview.emergentagent.com/services
