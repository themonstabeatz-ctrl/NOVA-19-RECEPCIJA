...
**URL:** `https://spa-cors-sync.preview.emergentagent.com/api/appointments/couple`
...
```bash
curl -X POST https://spa-cors-sync.preview.emergentagent.com/api/appointments/couple \
...
6. Kada korisnik submituje, pošalji na:
   POST https://spa-cors-sync.preview.emergentagent.com/api/appointments/couple
